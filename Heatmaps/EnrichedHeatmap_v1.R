...
plot.EnrHtmp(bigwigs = c("~/IMTB/Project_Leukemia/ATACseq_May2019/bigwig/WT_GMP_mean_TMM.bigwig",
                         "~/IMTB/Project_Leukemia/ATACseq_May2019/bigwig/WT_LSK_mean_TMM.bigwig",
                         "~/IMTB/Project_Leukemia/ATACseq_May2019/bigwig/URE_GMP_mean_TMM.bigwig",
                         "~/IMTB/Project_Leukemia/ATACseq_May2019/bigwig/URE_LSK_rep1_TMM.bigwig"),
